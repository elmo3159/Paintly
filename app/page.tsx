...
export default function HomePage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* 第2画面: キャッチフレーズセクション */}
      <section className="min-h-screen w-full bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 py-20 md:py-32 relative overflow-hidden flex items-center">
        {/* 背景装飾 */}
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8 text-center w-full">
          <div className="space-y-8 md:space-y-12">
            <p className="text-orange-400 font-bold text-lg md:text-xl tracking-wider uppercase">
              The Moment of Truth
            </p>

            <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold text-white leading-tight">
              「この家に住みたい」
            </h2>

            <p className="text-3xl md:text-5xl lg:text-6xl font-bold text-white/90 leading-tight">
              お客様がそう思った瞬間、<br />
