...
import { Star, Palette, Loader2, CheckCircle, XCircle, ChevronRight, ChevronDown, QrCode, ArrowRight, Calendar, Clock, Tag, BookOpen } from 'lucide-react'
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {/* 記事1 */}
            <Link href="/blog/ai-simulation-case-study" className="group">
              <article className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all overflow-hidden h-full flex flex-col">
                <div className="relative h-48 bg-gradient-to-br from-orange-100 to-pink-100 flex items-center justify-center">
                  <span className="text-orange-600 font-bold text-lg">導入事例</span>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-orange-50 text-orange-600 rounded-full text-xs font-semibold mb-3 w-fit">
                    <Tag className="h-3 w-3" />
                    導入事例
                  </span>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-orange-600 transition-colors">
                    AI塗装シミュレーションで成約率が2倍に！導入事例を徹底解説
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3 flex-1">
                    神奈川県の塗装会社がPaintlyを導入し、わずか3ヶ月で成約率が2倍に向上した事例を詳しく紹介します。
                  </p>
            ...
            {/* 記事2 */}
            <Link href="/blog/exterior-color-selection-guide" className="group">
              <article className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all overflow-hidden h-full flex flex-col">
                <div className="relative h-48 bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                  <span className="text-blue-600 font-bold text-lg">営業ノウハウ</span>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-xs font-semibold mb-3 w-fit">
                    <Tag className="h-3 w-3" />
                    営業ノウハウ
                  </span>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-orange-600 transition-colors">
                    外壁塗装の色選びで失敗しない方法｜プロが教える3つのコツ
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3 flex-1">
                    お客様が後悔しない色選びをサポートするために、塗装のプロが実践している3つのコツを紹介します。
                  </p>
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    <span className="flex items-center gap-1">
                      <Calendar className="h-3 w-3" />
            ...
            {/* 記事3 */}
            <Link href="/blog/digital-transformation-painting-business" className="group">
              <article className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all overflow-hidden h-full flex flex-col">
                <div className="relative h-48 bg-gradient-to-br from-green-100 to-teal-100 flex items-center justify-center">
                  <span className="text-green-600 font-bold text-lg">業務効率化</span>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-green-50 text-green-600 rounded-full text-xs font-semibold mb-3 w-fit">
                    <Tag className="h-3 w-3" />
                    業務効率化
                  </span>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-orange-600 transition-colors">
                    塗装営業の効率化術｜デジタルツールで変わる現場の働き方
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3 flex-1">
                    従来の営業スタイルからデジタル化への移行で、商談時間が60%短縮した塗装会社の事例を紹介。
                  </p>
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    <span className="flex items-center gap-1">
                      <Calendar className="h-3 w-3" />
            ...
            {/* 記事4 */}
            <Link href="/blog/popular-exterior-colors-2024" className="group">
              <article className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all overflow-hidden h-full flex flex-col">
                <div className="relative h-48 bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center">
                  <span className="text-purple-600 font-bold text-lg">業界トレンド</span>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-purple-50 text-purple-600 rounded-full text-xs font-semibold mb-3 w-fit">
                    <Tag className="h-3 w-3" />
                    業界トレンド
                  </span>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-orange-600 transition-colors">
                    人気の外壁色トップ10｜2024年最新トレンドを紹介
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3 flex-1">
                    2024年に最も選ばれている外壁色をランキング形式で紹介。トレンドカラーの特徴と提案ポイントを解説。
                  </p>
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    <span className="flex items-center gap-1">
                      <Calendar className="h-3 w-3" />
            ...
            {/* 記事5 */}
            <Link href="/blog/customer-anxiety-resolution" className="group">
              <article className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all overflow-hidden h-full flex flex-col">
                <div className="relative h-48 bg-gradient-to-br from-yellow-100 to-orange-100 flex items-center justify-center">
                  <span className="text-yellow-600 font-bold text-lg">営業ノウハウ</span>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-yellow-50 text-yellow-600 rounded-full text-xs font-semibold mb-3 w-fit">
                    <Tag className="h-3 w-3" />
                    営業ノウハウ
                  </span>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-orange-600 transition-colors">
                    お客様の不安を解消する提案方法｜塗装営業の成功事例
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3 flex-1">
                    「仕上がりが想像できない」というお客様の不安を解消し、信頼関係を築く提案方法を紹介します。
                  </p>
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    <span className="flex items-center gap-1">
                      <Calendar className="h-3 w-3" />
          ...
          <div className="text-center">
            <Link href="/blog">
              <Button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-6 text-lg font-bold shadow-lg transform hover:scale-105 transition-all">
